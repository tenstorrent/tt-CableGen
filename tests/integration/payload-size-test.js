 ...
 * to only include fields needed for export operations. Data is run through headless
...
function testPayloadSize(testFile) {
    ...
    try {
        // Import data from Python, then through headless Cytoscape (same shape as state.cy.elements().jsons())
